...
const badges = [
  ...
  { href: "https://chatgpt.com/", label: "ChatGPT", color: "74aa9c", localLogo: "openai" },
    ...
    <div className="ai-tool-grid">
      {badges.map((b, index) => (
        <a
          ...
          rel="noreferrer"
          aria-label={b.label}
          className="brand-badge ai-tool-card"
          style={{ "--brand-color": `#${b.color}` } as CSSProperties}
        >
          <span className="ai-tool-card__index" aria-hidden>
            {String(index + 1).padStart(2, "0")}
          </span>
          <span className="ai-tool-card__mark">
