...
export const papers: PaperVenue[] = [
  ...
  {
    id: "dpsws-2026",
    shortName: "IPSJ DPSWS 2026",
    fullName: "IPSJ Distributed Processing System Workshop",
    fullNameJa: "情報処理学会 第34回マルチメディア通信と分散処理ワークショップ",
  ...
  {
    id: "dicomo-2026",
    shortName: "IPSJ DICOMO 2026",
    fullName: "IPSJ Multimedia, Distributed, Cooperative, and Mobile Symposium",
    fullNameJa: "情報処理学会 マルチメディア，分散，協調とモバイル (DICOMO) シンポジウム",
  ...
  {
    id: "dpsws-2025",
    shortName: "IPSJ DPSWS 2025",
    fullName: "IPSJ Distributed Processing System Workshop",
    fullNameJa: "情報処理学会 第33回マルチメディア通信と分散処理ワークショップ",
